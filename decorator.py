...
student_details = Student("Rolf", "Schcool_Name")
...
class WorkingStudent(Student):
    ...
    # property decorator enables weekly_salary to act as an object not as methos. You can call weekly_salary() without brackets.
    @property
